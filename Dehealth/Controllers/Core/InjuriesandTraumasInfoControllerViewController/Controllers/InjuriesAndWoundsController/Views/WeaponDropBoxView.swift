...
protocol WeaponDropBoxViewDelegate: AnyObject {
	func didTapOnInjuriesView(_ view: WeaponDropBoxView)
}

class WeaponDropBoxView: UIView {
	 //MARK: - Properties
	weak var delegate: WeaponDropBoxViewDelegate?
	...
	private let nextButton: UIButton = {
		let image = UIImage(named: "trinagle 1")
	...
	private func configureUI() {
		...
		titleLabel.anchor(top: topAnchor, left: leftAnchor, bottom: bottomAnchor, right: nextButton.leftAnchor, paddingTop: 4, paddingLeft: 16, paddingBottom: 4, paddingRight: 10, height: 24)
	
		nextButton.anchor(top: topAnchor, bottom: bottomAnchor, right: rightAnchor, paddingTop: 4, paddingBottom: 4, paddingRight: 4, width: 20, height: 20)
	}
